...
import static casetrack.app.model.Model.PREDICATE_SHOW_ALL_PATIENTS;
...
import casetrack.app.commons.util.CollectionUtil;
...
public class EditCommand extends Command {
    ...
    private static Patient createEditedPatient(Patient patientToEdit, EditPatientDescriptor editPatientDescriptor) {
        ...
        return new Patient(updatedName, updatedPhone, updatedEmail,
                updatedAddress, patientToEdit.getIncome(), updatedTags, patientToEdit.getNotes());
    }
