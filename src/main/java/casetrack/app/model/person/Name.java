...
public class Name {
    ...
    public static final String MESSAGE_CONSTRAINTS =
            "Names should only contain alphanumeric characters, spaces, periods (.), apostrophes ('), hyphens (-),"
                    + " 's/o', 'd/o', 'S/O', or 'D/O', and it should not be blank. Names must contain at least one alphabetic character.";
     ...
     */
    public static final String VALIDATION_REGEX = "(?=.*[\\p{Alpha}])[\\p{Alnum}]([\\p{Alnum} .'-]|(([sd]/o)|([SD]/O) ))*";
